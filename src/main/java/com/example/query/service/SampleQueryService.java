...
public class SampleQueryService {
  ...
  public Optional<SampleDTO> get(Long id) {
    return queryGateway.query(new SampleQuery(id),
        ResponseTypes.optionalInstanceOf(SampleDTO.class)).join();
  }

  public List<SampleDTO> findAll() {
    return queryGateway.query(new SampleFindAllQuery(),
        ResponseTypes.multipleInstancesOf(SampleDTO.class)).join();
  }
}
